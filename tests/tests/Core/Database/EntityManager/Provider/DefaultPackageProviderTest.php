...
class DefaultPackageProviderTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $packagePath = DIR_BASE . '/' . DIRNAME_PACKAGES . '/test_metadatadriver_default';
    ...
    {
        $this->filesystem->makeDirectory(DIR_BASE . '/' . DIRNAME_PACKAGES . '/test_metadatadriver_legacy');
        $this->filesystem->makeDirectory(DIR_BASE . '/' . DIRNAME_PACKAGES . '/test_metadatadriver_legacy/' . DIRNAME_CLASSES);
    }

    private function removePackageFolderOfTestMetadataDriverLegacy()
    {
        $packagePath = DIR_BASE . '/' . DIRNAME_PACKAGES . '/test_metadatadriver_legacy';
